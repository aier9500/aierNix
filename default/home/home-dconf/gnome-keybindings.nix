...

{
  dconf.settings = {
    ...
    "org/gnome/desktop/wm/keybindings" = {
      switch-to-workspace-left = [ "<Control><Super>Left" "<Super>Page_Up" ];
      switch-to-workspace-right = [ "<Control><Super>Right" "<Super>Page_Down" ];
    ...
    "org/gnome/settings-daemon/plugins/media-keys" = {
      control-center = [ "<Super>I" "<Super>semicolon" ]; # Settings
    ...
    # custom1 — Mission Center (installed via flatpak, see home-apps.nix)
    "org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom1" = {
